...
Díky tomu DaisyUI poskytuje styly pro celé komponenty, jako jsou například tlačítka nebo alert boxy. Také poskytuje ovládání barevného schématu celé webové stránky, díky čemuž je s trochou konfigurace možné pomocí přibližně 20 barev ovládat celkový vzhled stránky.
...
\subsubsection{Implementování GET požadavků do aplikace}
...
přidat sem něco o tom že to je reaktivní. Já nevim. teď jsem si tenhle blok textu nečetl.
